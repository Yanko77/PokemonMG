...
Ce sont les pokémons des dresseurs ayant des stats modifiées.
"""
...
class Pokemon:
    """
    Classe représentant un pokémon spécial.
    Il est défini de la même façon qu'un pokémon classique.
    *Voir pokemon.Pokemon*
    """
