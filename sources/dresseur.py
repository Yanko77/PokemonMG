"""
Fichier gérant les dresseurs du jeu.
"""
...
class Dresseur:
    ...
    def __init__(self, name: str, game, dresseur_type='Classic', power=1, pk_lists=None, pk=None):
        ...
        if not self.name == 'Sauvage':
            self.icon = pygame.image.load(f'assets/icons/dresseurs/{self.name}.png')
...
def get_dresseur_by_name(name: str):
    """
...
"""
Liste de tous les dresseurs du jeu (Implémentés ou pas).
