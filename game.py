...
class Game:
    ...
    def start_fight(self, player_pk, dresseur_class=None, dresseur_pk=None, difficult):# passage de self.difficult en paramettre
    ...
    def init_fight(self, player_pk, dresseur_class=None, dresseur_pk=None, difficult):# passage de self.difficult en paramettre
